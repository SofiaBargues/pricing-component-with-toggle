    ...
    <div className="font-montserrat flex flex-col relative overflow-hidden w-[374px] h-full  justify-center  m-auto">
      ...
      <div className="m-9">
        ...
        <div className="flex justify-center gap-3 items-center flex-row text-[#aeaeba] relative font-bold text-md">
          ...
          <div className="bg-white left-[133px] h-5 rounded-full w-5 absolute"></div>
          <div className="bg-[#7a7ee1] w-12 h-7 rounded-full"></div>
          <div className="">Monthly</div>
        </div>
      </div>
      <div className="flex flex-col gap-[32px] my-6">
        <div className="rounded-lg w-[323px] h-[455px] text-sm  font-bold text-[#4c4f60] bg-white m-auto p-6 flex items-center justify-between flex-col ">
